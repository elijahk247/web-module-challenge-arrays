...
console.log('Task 1:', is31Flavors(originalFlavors));
...
console.log('Task 3: ', removeLastFlavor(originalFlavors));
...
console.log('Task 4: ', getFlavorByIndex(originalFlavors, 2));
...
console.log('Task 5: ', removeFlavorByName(originalFlavors, 'Vanilla'));
...
console.log('Task 6: ', copy(originalFlavors, flavorCopy)); 
/*
function copy(arr) {
    return [...arr];
}

console.log('How I would do Task 6: ', copy(originalFlavor));*/
